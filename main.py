...
if __name__ == '__main__':
    ...
    parser.add_argument('--lambda_star', type=float, default=0.1, help='weight for gradient penalty')
    parser.add_argument('--star_loss', action='store_true')
    ...
    parser.add_argument('--rafd_image_dir', type=str, default='data')
